...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$sunday || !$start_time || !$end_time || !$payableAmount || !$baptismfill_id || !$priestId) {
    ...
    if ($newScheduleId) {
        $result = $appointment->insertAppointment($baptismfill_id, $payableAmount,$priestId,$newScheduleId);
